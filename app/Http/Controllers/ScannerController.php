...
class ScannerController extends Controller
{
    ...
    public function apiStore(Request $request){
                ...
                // kalau siswa udah ambil hari ini, kasih tau mbg udah diambil, gak boleh ambil lagi
                if ($absensiHariIni) {
                    return response()->json([
                        'success' => false,
    ...
    public function apiReturn(Request $request){
                ...
                // kalau dia ga absen gaboleh scan
                if (!$absensi) {
                    return response()->json([
                        'success' => false,
                ...
                // cek kalau dia udah scan kembali
                ...
                // response sukses dengan data siswa dan waktu kembali
                return response()->json([
                    'success' => true,
