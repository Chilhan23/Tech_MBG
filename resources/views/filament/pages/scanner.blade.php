<x-filament-panels::page>
    <style>
        .scanner-wrap *, .scanner-wrap *::before, .scanner-wrap *::after { box-sizing: border-box; }
        ...
        .scan-ready.buffering { background: #eff6ff; border-color: #93c5fd; color: #1e40af; animation: scan-blink .5s ease-in-out infinite; }
        .scan-ready.lost      { background: #fef9c3; border-color: #fde047; color: #854d0e; }

        @keyframes scan-blink { 0%,100%{opacity:1} 50%{opacity:.6} }
        ...
        .scanner-subtitle { color: #6b7280; margin: 0 0 24px; line-height: 1.6; }
        ...
        #result-card.show {
            display: block;
            animation: scan-slideIn 0.25s ease;
        }
        ...
        .scanner-divider { border: none; border-top: 1px solid #e5e7eb; margin: 24px 0; }
