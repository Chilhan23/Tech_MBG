<x-filament-panels::page>
    <style>
        ...
        @media (max-width: 640px) { .sc-stats { grid-template-columns: 1fr; gap: 0.75rem; } }
    ...
    <div class="scanner-wrap">
        ...
        <div class="sc-page-header">
            <div>
                <div class="sc-page-title">Scanner Pengembalian Siswa</div>
                <div class="sc-page-subtitle">Scan NISN siswa setelah selesai makan</div>
            </div>
        ...
        <div class="sc-grid">
            ...
            <div class="sc-right-col">
                ...
                <div class="sc-card">
                    <div class="sc-card-header">
                        <span class="sc-card-header-title">Hasil Scan</span>
                    </div>
                ...
                <div class="sc-card">
                    <div class="sc-card-header">
                        <span class="sc-card-header-title">Input NISN Manual</span>
                    </div>
                    <div class="sc-card-body">
    ...
    <script>
        const API_URL      = '{{ route('scanner.api.return') }}';
        ...
        function setScanReady(state) {
            ...
            const msgs = {
                ready:     'Siap scan — arahkan alat barcode ke halaman ini',
        ...
        function showResult(data) {
            ...
            if (data.student) {
                ...
                body.innerHTML = `
                    ...
                    ${s.waktu_ambil ? `<div><div class="sc-info-key">Waktu Ambil</div><div class="sc-info-val">${s.waktu_ambil}</div></div>` : ''}
                    ${s.waktu_kembali ? `<div><div class="sc-info-key">Waktu Kembali</div><div class="sc-info-val">${s.waktu_kembali}</div></div>` : ''}
                `;
            } else {
